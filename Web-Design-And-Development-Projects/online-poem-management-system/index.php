...
<head>
    ...
    <title>Jahir's Poem Portal| Home Page</title>
    <!-- Bootstrap core CSS -->
...
<body>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 4%">
            <!-- Blog Entries Column -->
            <div class="col-md-2 mt-4" id="sideoption">
                <!-- Categories Widget -->
                <div class="card my-4 border-0">
                    <h5 class="card-header bg-white border-0"><font color="#ffffff">Categories</font></h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <div class="col-md-7">
                <h4 ="widget-title mb-4"><br><br>Welcome to <span>Mohammad Jahir Uddin's Online Poem Portal</span></h4>
                <!-- Blog Post -->
                <div class="row">
                    <div class="owl-carousel owl-theme" id="slider">
                        <div class="card mb-4 border-0">
                            <img class="card-img-top" src="images/p4.jpg" alt="" width="100%">
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
                                ...
                                <a href="#" class="card-title text-decoration-none text-dark">
                                    <h5 class="card-title">Mohammad Jahir Uddin's Art Work</h5>
                                </a>
                                <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Read More &rarr;</a> -->
                            </div>
                        </div>
                        <div class="card mb-4 border-0">
                            <img class="card-img-top" src="images/p1.jpg" alt="" width="100%">
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
                        ...
                        <div class="card mb-4 border-0">
                            <img class="card-img-top" src="images/p2.jpg" alt="" width="100%">
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 border-0">
								<br><center><font color="#000000"><b>মধুরিমা</b></font></center>
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
