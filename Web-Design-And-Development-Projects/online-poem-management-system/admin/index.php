...
<head>
    ...
    <!-- App title -->
    <title> Jahir's Poem Portal | Admin Panel</title>
    ...
    <section>
        ...
        <div class="container m-t-50">
            <div class="row align-items-center m-t-50">
                <div class="col-md-8 text-center" id="hideimage">
                    <center><img src="assets/images/blog-reading.png" width="850"></center>
                </div>
                <div class="col-md-4 ">
                        ...
                        <div class="m-t-40 account-pages">
                            <div class="account-logo-box">
                                <h2 class="text-uppercase">
                                    <center><a href="index.php" class="text-success">
                                        <span><img src="assets/images/m.jpg" alt="" width="280px"></span>
                                    </a></center><br>
                                </h2>
