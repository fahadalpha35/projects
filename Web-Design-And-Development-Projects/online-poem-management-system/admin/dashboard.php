                ...
                <div class="col-md-4">
                    <div class="card-box h-100">
                        <div class="card-header">
                            <h2 class="card-title mb-2">Welcome Mohammad Jahir Uddin </h2>
                        ...
                        <div class="card-body">
                            <div class="row ">
							<div class="col-md-6">
                                    <img src="assets/images/xaheer.jpg" width="140" height="150" class="rounded-start">
                                </div>
                                <div class="col-md-6">
                                    
                                    <br><br>
                                    <br>
                                    <a href="add-post.php"  class="btn btn-sm btn-primary">Add a poem</a>
                                </div>
                ...
                <a href="manage-posts.php">
                    <div class="col-lg-2 col-md-2 col-sm-6">
                        <div class="card-box widget-box-one text-center">
                            ...
                            <div class="wigdet-one-content">
                                <p class="m-0 text-secondary" title="User This Month">Live Poems</p>
