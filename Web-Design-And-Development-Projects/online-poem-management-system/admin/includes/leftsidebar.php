                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-newspaper"></i> <span> My Poems </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-post.php">Add Poems</a></li>
                                    <li><a href="manage-posts.php">Manage Poems</a></li>
                                    <li><a href="trash-posts.php">Trash Poems</a></li>
                                </ul>
                            </li>
