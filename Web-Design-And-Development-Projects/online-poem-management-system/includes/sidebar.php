...
<div class="col-md-3 ">
    ...
    <div class="card mb-4 border-0">
        <h5 class="card-header border-0 bg-white"><font color="#ffffff">Search</font></h5>
        <div class="card-body">
...
<!--  Author Name: MH RONY.
                        ...
                        for any PHP, Laravel, Python, Dart, Flutter work contact me at developer.mhrony@gmail.com  
                        Visit My Website : developerrony.com -->
<a href="tel:+8801790004664">
    <img src="images/ads.jpg" class="img-fluid"></a>

<!-- Side Widget -->
<div class="card my-4 border-0">
    <h5 class="card-header border-0 bg-white"><font color="#ffffff">Previous Poems</font></h5>
    <div class="card-body">
...
<!-- Side Widget -->
<div class="card my-4 border-0">
    <h5 class="card-header border-0 bg-white"><font color="#ffffff">Popular Poems</font></h5>
    <div class="card-body">
