            ...
            <div class="col-md-9 mt-5">
                ...
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <hr>
                        <img class="img-fluid w-60" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
                        <br><br><br><br><p class="card-text"><?php 
                        $pt=$row['postdetails'];
                                      echo  (substr($pt,0));?></p><br>
                    </div>
