...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update cover3</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT cover3.cover3_id, cover3.cover3_img, cover3.category, category.category_name FROM cover3
  LEFT JOIN category ON cover3.category = category.category_id
  LEFT JOIN user ON cover3.author = user.user_id
  WHERE cover3.cover3_id = {$cover3_id}";
...
?>
        ...
        <form action="save-update-cover3.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="cover3_id"  class="form-control" value="<?php echo $row['cover3_id']; ?>" placeholder="">
            </div>
 ...
 <option disabled selected> Select Category</option>
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                <label for="">cover3 image</label>
                <input type="file" name="new-image">
                <img  src="upload/<?php echo $row['cover3_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['cover3_img']; ?>">
            </div>
