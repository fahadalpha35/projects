...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <center><h1 class="admin-heading">Add New Faculty</h1></center>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form -->
                  <form  action="save-faculty.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          <label for="post_title">Faculty Name</label>
                          <input type="text" name="post_title" class="form-control" autocomplete="off" required>
                      </div>
					  <div class="form-group">
                          <label for="post_title1">Designation</label>
                          <input type="text" name="post_title1" class="form-control" autocomplete="off" required>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">Ph.D.</label>
                          <textarea name="post_title2" class="form-control" rows="3"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">M.Sc.</label>
                          <textarea name="post_title3" class="form-control" rows="3"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">B.Sc.</label>
                          <textarea name="post_title4" class="form-control" rows="3"  ></textarea>
                      </div>
                      <div class="form-group">
					  ...
					  <div class="form-group">
                          <label for="post_title5">Office</label>
                          <input type="text" name="post_title5" class="form-control" autocomplete="off" >
                      </div>
					  <div class="form-group">
                          <label for="post_title5">ID</label>
                          <input type="text" name="post_title6" class="form-control" autocomplete="off" required>
                      </div>
                      <div class="form-group">
