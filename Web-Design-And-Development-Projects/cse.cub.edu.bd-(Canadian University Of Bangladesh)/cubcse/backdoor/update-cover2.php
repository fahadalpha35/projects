...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update cover2</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT cover2.cover2_id, cover2.cover2_img, cover2.category, category.category_name FROM cover2
  LEFT JOIN category ON cover2.category = category.category_id
  LEFT JOIN user ON cover2.author = user.user_id
  WHERE cover2.cover2_id = {$cover2_id}";
...
?>
        ...
        <form action="save-update-cover2.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="cover2_id"  class="form-control" value="<?php echo $row['cover2_id']; ?>" placeholder="">
            </div>
 ...
 <option disabled selected> Select Category</option>
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                <label for="">cover2 image</label>
                <input type="file" name="new-image">
                <img  src="upload/<?php echo $row['cover2_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['cover2_img']; ?>">
            </div>
