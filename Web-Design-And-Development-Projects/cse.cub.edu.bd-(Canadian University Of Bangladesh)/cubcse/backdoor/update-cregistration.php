...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update cregistration</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT cregistration.cregistration_id, cregistration.title, cregistration.description, cregistration.cregistration_img, cregistration.category, category.category_name FROM cregistration
  LEFT JOIN category ON cregistration.category = category.category_id
  LEFT JOIN user ON cregistration.author = user.user_id
  WHERE cregistration.cregistration_id = {$post_id}";
...
?>
        ...
        <form action="save-update-cregistration.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['cregistration_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="upload/<?php echo $row['cregistration_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['cregistration_img']; ?>">
            </div>
