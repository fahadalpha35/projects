...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update Cover1</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT cover1.cover1_id, cover1.cover1_img, cover1.category, category.category_name FROM cover1
  LEFT JOIN category ON cover1.category = category.category_id
  LEFT JOIN user ON cover1.author = user.user_id
  WHERE cover1.cover1_id = {$cover1_id}";
...
?>
        ...
        <form action="save-update-cover1.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="cover1_id"  class="form-control" value="<?php echo $row['cover1_id']; ?>" placeholder="">
            </div>
 ...
 <option disabled selected> Select Category</option>
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                <label for="">Cover1 image</label>
                <input type="file" name="new-image">
                <img  src="upload/<?php echo $row['cover1_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['cover1_img']; ?>">
            </div>
