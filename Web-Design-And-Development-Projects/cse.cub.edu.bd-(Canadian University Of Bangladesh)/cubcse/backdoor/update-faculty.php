...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update Faculty</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT faculty.faculty_id, faculty.title, faculty.designation, faculty.phd, faculty.msc, faculty.bsc, faculty.description, faculty.office, faculty.faculty_img, faculty.position, faculty.category, category.category_name FROM faculty
...
?>
        ...
        <form action="save-update-faculty.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['faculty_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">Faculty Name</label>
                <input type="text" name="post_title"  class="form-control" id="exampleInputUsername" value="<?php echo $row['title']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputTile1">Designation</label>
                <input type="text" name="post_title1"  class="form-control" id="exampleInputUsername" value="<?php echo $row['designation']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Ph.D.</label>
                <textarea name="post_title2" class="form-control"  required rows="3">
                    <?php echo $row['phd']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword3">M.Sc.</label>
                <textarea name="post_title3" class="form-control"  required rows="3">
                    <?php echo $row['msc']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword4">B.Sc.</label>
                <textarea name="post_title4" class="form-control"  required rows="3">
                    <?php echo $row['bsc']; ?>
                </textarea>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Research Interests</label>
                <textarea name="postdesc" class="form-control"  required rows="5">
                    <?php echo $row['description']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputTile2">Office</label>
                <input type="text" name="post_title5"  class="form-control" id="exampleInputUsername" value="<?php echo $row['office']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputTile3">ID</label>
                <input type="text" name="post_title6"  class="form-control" id="exampleInputUsername" value="<?php echo $row['position']; ?>">
            </div>
            <div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['faculty_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['faculty_img']; ?>">
            </div>
