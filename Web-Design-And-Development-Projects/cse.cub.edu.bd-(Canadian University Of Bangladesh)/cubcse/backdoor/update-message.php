...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update Message</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT message.message_id, message.description, message.category, category.category_name FROM message
...
?>
        ...
        <form action="save-update-message.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="message_id"  class="form-control" value="<?php echo $row['message_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
