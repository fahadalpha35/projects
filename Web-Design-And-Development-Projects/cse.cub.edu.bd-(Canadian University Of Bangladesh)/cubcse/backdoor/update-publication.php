...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update Publication</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT publication.publication_id, publication.title, publication.description, publication.link, publication.position, publication.category, category.category_name FROM publication
...
?>
        ...
        <form action="save-update-publication.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="publication_id"  class="form-control" value="<?php echo $row['publication_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
			...
			<div class="form-group">
                <label for="exampleInputPassword1">Paper Publication Link</label>
                <textarea name="postdesc1" class="form-control"  rows="5">
                    <?php echo $row['link']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputTile">ID</label>
                <input type="text" name="post_title1"  class="form-control" id="exampleInputUsername" value="<?php echo $row['position']; ?>">
            </div>
            <div class="form-group">
