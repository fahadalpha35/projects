<?php
  ...
  $sql = "INSERT INTO fees(description1,description2,description3,description4,description5,description6,description7,description8,description9,description10,category,fees_date,author)


          VALUES('{$description1}','{$description2}','{$description3}','{$description4}','{$description5}','{$description6}','{$description7}','{$description8}','{$description9}','{$description10}',{$category},'{$date}',{$author});";
