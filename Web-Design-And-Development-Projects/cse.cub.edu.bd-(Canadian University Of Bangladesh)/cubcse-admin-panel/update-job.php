...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update job</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT job.job_id, job.name, job.link, job.job_img, job.category, category.category_name FROM job
...
?>
        ...
        <form action="save-update-job.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['job_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">Job Name</label>
                <input type="text" name="post_title"  class="form-control" id="exampleInputUsername" value="<?php echo $row['name']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputTile1">Website Link</label>
                <input type="text" name="post_title1"  class="form-control" id="exampleInputUsername" value="<?php echo $row['link']; ?>">
            </div>
            <div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['job_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['job_img']; ?>">
            </div>
