<?php
  ...
  $sql = "INSERT INTO publication(title, description, link, position, category,publication_date,author)


          VALUES('{$title}','{$description}','{$description1}','{$title1}',{$category},'{$date}',{$author});";
