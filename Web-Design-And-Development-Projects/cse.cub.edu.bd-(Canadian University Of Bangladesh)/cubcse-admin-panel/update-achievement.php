...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update achievement</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT achievement.achievement_id, achievement.title, achievement.description, achievement.link, achievement.achievement_img, achievement.category, category.category_name FROM achievement
...
?>
        ...
        <form action="save-update-achievement.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['achievement_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">Achievement Title</label>
                <input type="text" name="post_title"  class="form-control" id="exampleInputUsername" value="<?php echo $row['title']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputPassword1">Achievement Description</label>
                <textarea name="post_title1" class="form-control"  required rows="5">
                    <?php echo $row['description']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputTile1">Achievement Link</label>
                <input type="text" name="post_title2"  class="form-control" id="exampleInputUsername" value="<?php echo $row['link']; ?>">
            </div>
            <div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['achievement_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['achievement_img']; ?>">
            </div>
