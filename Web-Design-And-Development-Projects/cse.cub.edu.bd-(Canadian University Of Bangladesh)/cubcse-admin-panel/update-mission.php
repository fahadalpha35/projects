...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update mission</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT mission.mission_id, mission.description, mission.category, category.category_name FROM mission
...
?>
        ...
        <form action="save-update-mission.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="mission_id"  class="form-control" value="<?php echo $row['mission_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
