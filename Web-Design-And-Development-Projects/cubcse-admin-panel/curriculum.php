...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading">Course Curriculum</h1>
              </div>
...
if($_SESSION['user_role'] == '1'){
   $query = "SELECT curriculum.curriculum_id, curriculum.link, curriculum.curriculum_date,curriculum.category, category.category_name,user.username FROM curriculum
  ...
  LEFT JOIN category ON curriculum.category = category.category_id
  LEFT JOIN user ON curriculum.author = user.user_id
  WHERE curriculum.author = {$_SESSION['user_id']}
  ORDER BY curriculum.curriculum_id DESC LIMIT {$offset },{$limit}";
}
...
?>
                          <tr>
                              ...
                              <td><?php echo $row['curriculum_date'] ?></td>
                              <td><?php echo $row['username'] ?></td>

<td class='edit'><a href='update-curriculum.php?id=<?php echo $row['curriculum_id'] ?>'><i class='fa fa-edit'></i></a></td>
...
<?php 
      ...
      if(mysqli_num_rows($result2)){
        ...
        if($page_number > 1){
          echo '<li><a href="curriculum.php?page='.($page_number-1).'">prev</a></li>';
        }
        ...
        if($total_page > $page_number){
          echo '<li><a href="curriculum.php?page='.($page_number+1).'">next</a></li>';
        }
        echo "</ul>";
      }
