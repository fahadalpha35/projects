...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update curriculum</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT curriculum.curriculum_id, curriculum.link, curriculum.category, category.category_name FROM curriculum
...
?>
        ...
        <form action="save-update-curriculum.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="curriculum_id"  class="form-control" value="<?php echo $row['curriculum_id']; ?>" placeholder="">
            </div>
			<div class="form-group">
                <label for="exampleInputPassword1">Course Curriculum Drive Link</label>
