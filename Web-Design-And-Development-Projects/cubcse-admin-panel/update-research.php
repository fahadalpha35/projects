...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update research</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT research.research_id, research.description1, research.description2, research.description3, research.description4, research.description5, research.description6, research.research_img, research.category, category.category_name FROM research
...
?>
        ...
        <form action="save-update-research.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['research_id']; ?>" placeholder="">
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Research Name</label>
                <textarea name="post_title1" class="form-control"  rows="2">
                    <?php echo $row['description1']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">DIRECTOR OF THE CELL:</label>
                <textarea name="post_title2" class="form-control"  rows="2">
                    <?php echo $row['description2']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Objective:</label>
                <textarea name="post_title3" class="form-control"  rows="5">
                    <?php echo $row['description3']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Description:</label>
                <textarea name="post_title4" class="form-control"  rows="5">
                    <?php echo $row['description4']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Supervisor:</label>
                <textarea name="post_title5" class="form-control"  rows="1">
                    <?php echo $row['description5']; ?>
                </textarea>
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Students:</label>
 ...
 <option disabled selected> Select Category</option>
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                <label for="">research image</label>
                <input type="file" name="new-image">
                <img  src="../backdoor/upload/<?php echo $row['research_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['research_img']; ?>">
            </div>
