...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <center><h1 class="admin-heading">Add New ifees</h1></center>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form -->
                  <form  action="save-ifees.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          <label for="exampleInputPassword1"> Program</label>
                          <textarea name="postdesc1" class="form-control" rows="2"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Calendar</label>
                          <textarea name="postdesc2" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Trimesters</label>
                          <textarea name="postdesc3" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Total Credit Hours</label>
                          <textarea name="postdesc4" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Admission Fee (One time) $</label>
                          <textarea name="postdesc5" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> International Student Fee / Trimester $</label>
                          <textarea name="postdesc6" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Service Fee / Trimester $</label>
                          <textarea name="postdesc7" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Tuition Fee / Credit Hours $</label>
                          <textarea name="postdesc8" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Total Tuition Fee $</label>
                          <textarea name="postdesc9" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Total Tuition Fee (after 40% waiver) $</label>
                          <textarea name="postdesc10" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Total Cost $</label>
                          <textarea name="postdesc11" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Total Cost (after 40% waiver) $</label>
                          <textarea name="postdesc12" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Total Cost (after 40% waiver) BDT</label>
                          <textarea name="postdesc13" class="form-control" rows="1"  ></textarea>
                      </div>
                      <div class="form-group">
