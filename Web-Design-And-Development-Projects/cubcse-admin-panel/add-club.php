...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <center><h1 class="admin-heading">Add New club</h1></center>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form -->
                  <form  action="save-club.php" method="POST" enctype="multipart/form-data">

					  <div class="form-group">
                          <label for="exampleInputPassword1">Club Name</label>
                          <textarea name="post_title1" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">Advisor</label>
                          <textarea name="post_title2" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">President</label>
                          <textarea name="post_title3" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">General Secretary</label>
                          <textarea name="post_title4" class="form-control" rows="1"  ></textarea>
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">Treasurer</label>
					  ...
					  <div class="form-group">
                          ...
                          <textarea name="post_title7" class="form-control" rows="1"  ></textarea>
                      </div>
