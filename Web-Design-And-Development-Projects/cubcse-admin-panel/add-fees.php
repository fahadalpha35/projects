...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <center><h1 class="admin-heading">Add New fees</h1></center>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form -->
                  <form  action="save-fees.php" method="POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
                          <label for="exampleInputPassword1"> Tuition Fee / Credit Hour</label>
