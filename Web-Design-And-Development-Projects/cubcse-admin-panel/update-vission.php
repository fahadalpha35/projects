...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update vission</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT vission.vission_id, vission.description, vission.category, category.category_name FROM vission
  LEFT JOIN category ON vission.category = category.category_id
  LEFT JOIN user ON vission.author = user.user_id
  WHERE vission.vission_id = {$vission_id}";
...
?>
        ...
        <form action="save-update-vission.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="vission_id"  class="form-control" value="<?php echo $row['vission_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
