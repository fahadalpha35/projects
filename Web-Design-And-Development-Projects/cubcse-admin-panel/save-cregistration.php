<?php
  ...
  $sql = "INSERT INTO cregistration(title, description,category,cregistration_date,author,cregistration_img)


          VALUES('{$title}','{$description}',{$category},'{$date}',{$author},'{$new_name}');";

  $sql .= "UPDATE category SET cregistration = cregistration + 1 WHERE category_id = {$category}";
