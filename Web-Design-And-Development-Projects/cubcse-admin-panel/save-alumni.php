<?php
  ...
  $sql = "INSERT INTO alumni(title, designation, year, category,alumni_date,author,alumni_img, position)


          VALUES('{$title3}','{$title1}','{$title2}',{$category},'{$date}',{$author},'{$new_name}',{$title6});";
