...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <center><h1 class="admin-heading">Add New Alumni</h1></center>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form -->
                  <form  action="save-alumni.php" method="POST" enctype="multipart/form-data">
					  <div class="form-group">
                          <label for="post_title3">Alumni Name</label>
                          <input type="text" name="post_title3" class="form-control" autocomplete="off" required>
                      </div>
					  <div class="form-group">
                          <label for="post_title1">Company Name</label>
                          <input type="text" name="post_title1" class="form-control" >
                      </div>
					  <div class="form-group">
                          <label for="exampleInputPassword1">Passing Year</label>
                          <textarea name="post_title2" class="form-control" autocomplete="off" required  ></textarea>
                      </div>
