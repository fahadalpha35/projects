   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Add New Drone Station</h4>
            ...
            <form id="geofencesave" method="post" action="<?php echo base_url(); ?>vehicle/addgroup">
               <div class="card-body">
                  <div class="form-group row">
                     <label for="geo_name" class="col-sm-4 col-form-label">Station Name</label>
                     <div class="form-group col-sm-8">
                        <input type="text" class="form-control" name="gr_name" id="gr_name" required="true" placeholder="Enter Station Name">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="Cateogry" class="col-sm-4 col-form-label">Station Location</label>
                     <div class="form-group col-sm-8">
                        <input type="text" class="form-control" name="gr_desc" id="gr_desc" required="true" placeholder="Enter Station Location">
                     </div>
                  </div>
               </div>
         </div>
