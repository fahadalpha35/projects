    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($userdetails))?'Edit Admin User':'Add Admin User' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">User</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($userdetails))?'Edit Admin User':'Add Admin User' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <form method="post" id="vehicle_add" class="card basicvalidation" action="<?php echo base_url();?>users/<?php echo (isset($userdetails))?'updateuser':'insertuser'; ?>">
                <div class="card-body">
                   ...
                   <input type="hidden" name="basic[u_id]" id="u_id"  value="<?php echo (isset($userdetails)) ? $userdetails[0]['u_id']:'' ?>" >
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-md-2">
                        <div class="form-group">
                          <label class="form-label">Medicine Orders</label>
                        </div>
                      </div>
                  ...
                  <div class="row">
                      <div class="col-sm-6 col-md-2">
                        <div class="form-group">
                          <label class="form-label">Drone Station</label>
                        </div>
                      </div>
                      <div class="form-group mr-4">
                        <div class="custom-control custom-checkbox">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group mr-4">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label class="custom-control-label" for="lr_trips_list">All List</label>
                        </div>
                      </div>
                      <div class="form-group mr-4">
                        <div class="custom-control custom-checkbox">
