<?php
  ...
  $sql = "INSERT INTO achievement(title, description, link, category,achievement_date,author,achievement_img)


          VALUES('{$title3}','{$title2}','{$title1}',{$category},'{$date}',{$author},'{$new_name}');";
