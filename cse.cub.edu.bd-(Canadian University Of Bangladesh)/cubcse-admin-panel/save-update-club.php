...
$query = "UPDATE club SET 
		description1='{$_POST["post_title1"]}',
		description2='{$_POST["post_title2"]}',
		description3='{$_POST["post_title3"]}',
		description4='{$_POST["post_title4"]}',
		description5='{$_POST["post_title5"]}',
		description6='{$_POST["post_title6"]}',
		description7='{$_POST["post_title7"]}',
		category={$_POST["category"]},
        club_img='{$image_name}' 
        WHERE club_id={$_POST["post_id"]}; ";
