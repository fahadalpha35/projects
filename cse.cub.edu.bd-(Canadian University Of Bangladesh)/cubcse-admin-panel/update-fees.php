...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update fees</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT fees.fees_id, fees.description1, fees.description2, fees.description3, fees.description4, fees.description5, fees.description6, fees.description7, fees.description8, fees.description9, fees.description10, fees.category, category.category_name FROM fees
  LEFT JOIN category ON fees.category = category.category_id
  LEFT JOIN user ON fees.author = user.user_id
  WHERE fees.fees_id = {$fees_id}";
...
?>
        ...
        <form action="save-update-fees.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="fees_id"  class="form-control" value="<?php echo $row['fees_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
