...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update administration</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT administration.admin_id, administration.title, administration.designation, administration.email, administration.admin_img, administration.position, administration.category, category.category_name FROM administration
  LEFT JOIN category ON administration.category = category.category_id
  LEFT JOIN user ON administration.author = user.user_id
  WHERE administration.admin_id = {$administration_id}";
...
?>
        ...
        <form action="save-update-administration.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['admin_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">administration Name</label>
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['admin_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['admin_img']; ?>">
            </div>
