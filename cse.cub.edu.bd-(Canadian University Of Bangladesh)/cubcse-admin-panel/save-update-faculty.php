...
$query = "UPDATE faculty SET 
		...
		designation='{$_POST["post_title1"]}',
		phd='{$_POST["post_title2"]}',
		msc='{$_POST["post_title3"]}',
		bsc='{$_POST["post_title4"]}',
        description='{$_POST["postdesc"]}',
        office='{$_POST["post_title5"]}',
		position='{$_POST["post_title6"]}',
		category={$_POST["category"]},
        faculty_img='{$image_name}' 
        WHERE faculty_id={$_POST["post_id"]}; ";
