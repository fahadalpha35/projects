<?php
  ...
  $sql = "INSERT INTO faculty(title, designation, phd, msc, bsc, description, office, category,faculty_date,author,faculty_img, position)


          VALUES('{$title}','{$title1}','{$title2}','{$title3}','{$title4}','{$description}','{$title5}',{$category},'{$date}',{$author},'{$new_name}',{$title6});";
