...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <center><h1 class="admin-heading">Add New Office Stuff</h1></center>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form -->
                  <form  action="save-ostuff.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          <label for="post_title">Designation Title</label>
                          <input type="text" name="post_title" class="form-control" autocomplete="off" required>
                      </div>
					  <div class="form-group">
                          <label for="post_title3">Stuff Name</label>
                          <input type="text" name="post_title3" class="form-control" autocomplete="off" required>
                      </div>
					  <div class="form-group">
