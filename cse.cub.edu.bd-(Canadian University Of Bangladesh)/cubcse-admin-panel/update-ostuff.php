...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update ostuff</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT ostuff.ostuff_id, ostuff.title, ostuff.name, ostuff.designation, ostuff.email, ostuff.ostuff_img, ostuff.position, ostuff.category, category.category_name FROM ostuff
  LEFT JOIN category ON ostuff.category = category.category_id
  LEFT JOIN user ON ostuff.author = user.user_id
  WHERE ostuff.ostuff_id = {$ostuff_id}";
...
?>
        ...
        <form action="save-update-ostuff.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['ostuff_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">Designation Title</label>
                <input type="text" name="post_title"  class="form-control" id="exampleInputUsername" value="<?php echo $row['title']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputTile5">Stuff Name</label>
                <input type="text" name="post_title3"  class="form-control" id="exampleInputUsername" value="<?php echo $row['name']; ?>">
            </div>
			<div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['ostuff_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['ostuff_img']; ?>">
            </div>
