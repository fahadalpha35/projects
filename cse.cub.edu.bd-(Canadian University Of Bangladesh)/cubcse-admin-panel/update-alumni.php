...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update alumni</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT alumni.alumni_id, alumni.title, alumni.year, alumni.designation, alumni.alumni_img, alumni.position, alumni.category, category.category_name FROM alumni
...
?>
        ...
        <form action="save-update-alumni.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['alumni_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">Alumni Name</label>
                <input type="text" name="post_title"  class="form-control" id="exampleInputUsername" value="<?php echo $row['title']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputTile1">Company Name</label>
                <input type="text" name="post_title1"  class="form-control" id="exampleInputUsername" value="<?php echo $row['designation']; ?>">
            </div>
			<div class="form-group">
                <label for="exampleInputPassword2">Passing Year</label>
                <textarea name="post_title2" class="form-control"  required rows="1">
                    <?php echo $row['year']; ?>
                </textarea>
            </div>
			<div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['alumni_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['alumni_img']; ?>">
            </div>
