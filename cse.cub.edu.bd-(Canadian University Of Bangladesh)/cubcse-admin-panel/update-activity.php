...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update activity</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT activity.activity_id, activity.description, activity.activity_img, activity.category, category.category_name FROM activity
...
?>
        ...
        <form action="save-update-activity.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['activity_id']; ?>" placeholder="">
            </div>
			<div class="form-group">
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['activity_img']; ?>" height="150px">
