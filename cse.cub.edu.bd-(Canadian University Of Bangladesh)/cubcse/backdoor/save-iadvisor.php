<?php
  ...
  $sql = "INSERT INTO iadvisor(title, designation, email, category,iadvisor_date,author,iadvisor_img, position)


          VALUES('{$title}','{$title1}','{$title2}',{$category},'{$date}',{$author},'{$new_name}',{$title6});";
