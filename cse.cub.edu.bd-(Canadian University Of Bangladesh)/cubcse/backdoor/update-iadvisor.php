...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update Internation Advisor</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT iadvisor.iadvisor_id, iadvisor.title, iadvisor.designation, iadvisor.email, iadvisor.iadvisor_img, iadvisor.position, iadvisor.category, category.category_name FROM iadvisor
  LEFT JOIN category ON iadvisor.category = category.category_id
  LEFT JOIN user ON iadvisor.author = user.user_id
  WHERE iadvisor.iadvisor_id = {$iadvisor_id}";
...
?>
        ...
        <form action="save-update-iadvisor.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="post_id"  class="form-control" value="<?php echo $row['iadvisor_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="exampleInputTile">I Advisor Name</label>
  ...
  <?php  
   ...
   ?>
            ...
            <div class="form-group">
                ...
                <img  src="../backdoor/upload/<?php echo $row['iadvisor_img']; ?>" height="150px">
                <input type="hidden" name="old_image" value="<?php echo $row['iadvisor_img']; ?>">
            </div>
