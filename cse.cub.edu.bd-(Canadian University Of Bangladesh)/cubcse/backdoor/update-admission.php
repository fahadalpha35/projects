...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update admission</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT admission.admission_id, admission.description, admission.category, category.category_name FROM admission
...
?>
        ...
        <form action="save-update-admission.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="admission_id"  class="form-control" value="<?php echo $row['admission_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
