...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update outcome</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT outcome.outcome_id, outcome.description, outcome.category, category.category_name FROM outcome
...
?>
        ...
        <form action="save-update-outcome.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="outcome_id"  class="form-control" value="<?php echo $row['outcome_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
