...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update ctransfer</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT ctransfer.ctransfer_id, ctransfer.description, ctransfer.category, category.category_name FROM ctransfer
  LEFT JOIN category ON ctransfer.category = category.category_id
  LEFT JOIN user ON ctransfer.author = user.user_id
  WHERE ctransfer.ctransfer_id = {$ctransfer_id}";
...
?>
        ...
        <form action="save-update-ctransfer.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="ctransfer_id"  class="form-control" value="<?php echo $row['ctransfer_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
