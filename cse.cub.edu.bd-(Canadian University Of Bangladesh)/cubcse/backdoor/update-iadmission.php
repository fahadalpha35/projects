...
if($_SESSION['user_role'] == '0'){
  header("location: iadmission.php");
}
...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update iadmission</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT iadmission.iadmission_id, iadmission.description, iadmission.category, category.category_name FROM iadmission
  LEFT JOIN category ON iadmission.category = category.category_id
  LEFT JOIN user ON iadmission.author = user.user_id
  WHERE iadmission.iadmission_id = {$iadmission_id}";
...
?>
        ...
        <form action="save-update-iadmission.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                <input type="hidden" name="iadmission_id"  class="form-control" value="<?php echo $row['iadmission_id']; ?>" placeholder="">
            </div>
            <div class="form-group">
