...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <center><h1 class="admin-heading">Update Notice</h1></center>
    </div>
...
<?php 
  ...
  $query = "SELECT notice.notice_id, notice.title, notice.description, notice.category, category.category_name FROM notice
