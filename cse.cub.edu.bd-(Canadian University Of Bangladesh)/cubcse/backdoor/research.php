...
<div class="container-fluid">
  ...
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading">All Research Lists</h1>
              </div>
              <div class="col-md-2">
                  <a class="add-new" href="add-research.php"><button class="btn">Add research</button></a>
              </div>
              <div class="col-md-12">
<br>
<?php 
...
if($_SESSION['user_role'] == '1'){
   $query = "SELECT research.research_id, research.description1, research.description2, research.description3, research.description4, research.description5, research.description6, research.research_img, research.research_date,research.category, category.category_name,user.username FROM research
  ...
  LEFT JOIN category ON research.category = category.category_id
  LEFT JOIN user ON research.author = user.user_id
  WHERE research.author = {$_SESSION['user_id']}
  ORDER BY research.research_id DESC LIMIT {$offset },{$limit}";
}
...
?>
                          <tr>
                              ...
                              <td><img height="50px" src="upload/<?php echo $row['research_img'] ?>"></td>
                              <td><?php echo $row['description1'] ?></td>
                              <td><?php echo $row['category_name'] ?></td>
                              <td><?php echo $row['research_date'] ?></td>
                              <td><?php echo $row['username'] ?></td>

<td class='edit'><a href='update-research.php?id=<?php echo $row['research_id'] ?>'><i class='fa fa-edit'></i></a></td>
<td class='delete'><a onclick="return confirm('Are You Sure?')" href='delete-research.php?id=<?php echo $row['research_id'] ?>&catid=<?php echo $row['category'] ?>'><i class='fa fa-trash-o'></i></a></td>
...
<?php 
      ...
      if(mysqli_num_rows($result2)){
        ...
        if($page_number > 1){
          echo '<li><a href="research.php?page='.($page_number-1).'">prev</a></li>';
        }
        ...
        for($i = 1; $i <= $total_page; $i++){
          ...
          echo '<li class='.$active.'><a href="research.php?page='.$i.'">'.$i.'</a></li>';
        }
        if($total_page > $page_number){
          echo '<li><a href="research.php?page='.($page_number+1).'">next</a></li>';
        }
        echo "</ul>";
      }
